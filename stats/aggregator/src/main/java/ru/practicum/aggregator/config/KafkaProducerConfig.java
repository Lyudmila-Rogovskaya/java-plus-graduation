...
import ru.practicum.ewm.stats.avro.serialization.EventsSimilarityAvroSerializer;
...
public class KafkaProducerConfig {
    ...
    public ProducerFactory<String, EventsSimilarityAvro> producerFactory() {
        ...
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, EventsSimilarityAvroSerializer.class);
